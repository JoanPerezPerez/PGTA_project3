import pandas as pd
from functions.ias_functions import extract_IAS_by_altitude, extract_IAS_by_altitude_single_line, save_results_csv
...
def main_IAS():
    ...
    df_24L_stats = extract_IAS_by_altitude_single_line(df_24L)
    # Para 06R
    df_06R = join_plan_radar(path_plan, path_rad, runway="LEBL-06R")
    #df_06R_stats = extract_IAS_by_altitude(df_06R)
    df_06R_stats = extract_IAS_by_altitude_single_line(df_06R)
